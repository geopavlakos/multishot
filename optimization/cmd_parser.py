...
def parse_config(argv=None):
    ...
    parser.add_argument('--npz', default=None, type=str,
                        help='Path to npz')
    ...
    parser.add_argument('--motion_smooth', type=str, default='single_frame',
                        choices=['multi_shot'],
                        help='Which type of smoothness?')
    ...
    parser.add_argument('--motion_prior_canonical_joints_weight',
                        default=1e+7, type=float,
                        nargs='*',
                        help='The weight for the joints in the canonical space')
